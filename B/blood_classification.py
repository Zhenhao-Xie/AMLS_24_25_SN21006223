...
class BloodClassification:
    def __init__(self, download=True):
        ...
        self.train_dataset = BloodMNIST(split='train', root="Datasets", transform=data_transform, download=self.download)
        self.val_dataset   = BloodMNIST(split='val',   root="Datasets", transform=data_transform)
        self.test_dataset  = BloodMNIST(split='test',  root="Datasets", transform=data_transform)
    ...
    class ResNet18(nn.Module):
        def __init__(self, num_classes):
            ...
            # Modify first conv layer to accept 3-channel input
    ...
    def train_resnet(self, 
        ...
        """
        Train ResNet-18 model with hyperparameter search.
        """
        ...
        plt.xlabel("Epoch")
        plt.ylabel("Loss")
        plt.title("Task B ResNet-18 Training Curve (Best Hyperparams)")
        plt.legend()
